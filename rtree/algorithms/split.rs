    ...
    fn test_quadratic_split() {
        ...
        assert!(
            (group1_data.contains(&"1".to_string()) && group1_data.contains(&"3".to_string()))
                || (group2_data.contains(&"1".to_string())
                    && group2_data.contains(&"3".to_string()))
                || (group1_data.contains(&"2".to_string())
                    && group1_data.contains(&"4".to_string()))
                || (group2_data.contains(&"2".to_string())
                    && group2_data.contains(&"4".to_string()))
        );
    }
